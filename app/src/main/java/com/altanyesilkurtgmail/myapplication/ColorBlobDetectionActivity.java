...
public class ColorBlobDetectionActivity extends Activity implements OnTouchListener, CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.a);
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        SPECTRUM_SIZE = new Size(300, 200);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        Mat edges = new Mat();
        Imgproc.medianBlur(mRgba, edges, 15);
        ...
        /*   medianFilter(inputFrame, outputFrame, 3);
             // Blob tespiti yapılacak alan.. Çerçeveye alınacak.
            // Çerçevenin orrijinal görüntüde basılması*/
